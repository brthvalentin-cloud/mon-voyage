...
<input className=“inp” placeholder=“Ex: Vol Paris→Rome, Musée du Louvre…” value={form.ville} onChange={(e) => setForm({ …form, ville: e.target.value })} />
</div>
<div className="input-group">
...
<input className=“inp” placeholder=“Détails, confirmation, adresse…” value={form.note} onChange={(e) => setForm({ …form, note: e.target.value })} />
</div>
