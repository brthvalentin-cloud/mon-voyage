...
if (!s._id) {
changed = true;
return { …s, *id: “s*” + Math.random().toString(36).slice(2, 9) };
}
return s;
});
...
const addStop = (form) => {
const newStop = { …form, *id: “s*” + Math.random().toString(36).slice(2, 9) };
...
return (
<>
<style>{`@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap'); *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; } body { background: #F7F7F7; color: #222; font-family: 'Plus Jakarta Sans', sans-serif; min-height: 100vh; } .app { max-width: 480px; margin: 0 auto; min-height: 100vh; background: #fff; box-shadow: 0 0 40px rgba(0,0,0,0.08); padding-bottom: 100px; } .home-header { padding: 3rem 1.5rem 1.5rem; background: linear-gradient(135deg, #FF5A5F, #FC642D); color: #fff; } .home-eyebrow { font-size: 0.7rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; opacity: 0.85; margin-bottom: 0.3rem; } .home-title { font-size: 1.8rem; font-weight: 700; letter-spacing: -0.03em; } .btn-new-voyage { width: 100%; display: flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 1rem; border: 2px dashed #FF5A5F; border-radius: 14px; background: rgba(255,90,95,0.03); color: #FF5A5F; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 700; font-size: 0.95rem; cursor: pointer; transition: all 0.2s; margin-bottom: 1.5rem; } .btn-new-voyage:hover { background: rgba(255,90,95,0.08); } .btn-new-icon { font-size: 1.3rem; } .voyage-list { display: flex; flex-direction: column; gap: 0.85rem; } .voyage-card { background: #fff; border: 1px solid #EBEBEB; border-radius: 16px; padding: 1.25rem; cursor: pointer; transition: all 0.2s; box-shadow: 0 2px 8px rgba(0,0,0,0.04); } .voyage-card:hover { box-shadow: 0 4px 20px rgba(0,0,0,0.1); transform: translateY(-1px); } .voyage-card-top { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.85rem; } .voyage-destination { font-size: 0.72rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #FF5A5F; margin-bottom: 0.2rem; } .voyage-name { font-size: 1.1rem; font-weight: 700; color: #222; margin-bottom: 0.25rem; } .voyage-dates { font-size: 0.78rem; color: #717171; } .btn-delete-voyage { background: #F7F7F7; border: none; width: 32px; height: 32px; border-radius: 50%; cursor: pointer; font-size: 0.85rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0; transition: background 0.15s; } .btn-delete-voyage:hover { background: #FFE8E8; } .voyage-stats { display: flex; gap: 0.75rem; flex-wrap: wrap; } .voyage-stat { font-size: 0.78rem; color: #484848; background: #F7F7F7; padding: 0.3rem 0.7rem; border-radius: 20px; font-weight: 500; } .header { padding: 2rem 1.5rem 0; background: #fff; position: sticky; top: 0; z-index: 10; border-bottom: 1px solid #EBEBEB; } .btn-back { background: none; border: none; color: #FF5A5F; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.85rem; font-weight: 600; cursor: pointer; padding: 0; margin-bottom: 0.75rem; display: block; } .header-eyebrow { font-size: 0.7rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #FF5A5F; margin-bottom: 0.2rem; } .header-title { font-size: 1.5rem; font-weight: 700; color: #222; letter-spacing: -0.03em; margin-bottom: 0.2rem; } .header-dates { font-size: 0.78rem; color: #717171; margin-bottom: 0.85rem; } .tabs { display: flex; margin: 0 -1.5rem; padding: 0 1.5rem; overflow-x: auto; scrollbar-width: none; } .tabs::-webkit-scrollbar { display: none; } .tab { flex-shrink: 0; padding: 0.75rem; border: none; background: transparent; color: #717171; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.78rem; font-weight: 600; cursor: pointer; border-bottom: 2px solid transparent; transition: all 0.2s; display: flex; align-items: center; gap: 0.3rem; white-space: nowrap; } .tab.active { color: #222; border-bottom: 2px solid #FF5A5F; } .section { padding: 1.5rem; } .form-card { background: #fff; border: 1px solid #EBEBEB; border-radius: 16px; margin-bottom: 1.25rem; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.06); } .form-header { display: flex; justify-content: space-between; align-items: center; padding: 1rem 1.25rem; border-bottom: 1px solid #EBEBEB; font-weight: 600; font-size: 0.9rem; color: #222; } .btn-close { background: #F7F7F7; border: none; width: 28px; height: 28px; border-radius: 50%; cursor: pointer; font-size: 0.75rem; color: #717171; display: flex; align-items: center; justify-content: center; } .form-body { padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem; } .input-group { display: flex; flex-direction: column; gap: 0.35rem; } .input-row { display: flex; gap: 0.75rem; } .input-label { font-size: 0.75rem; font-weight: 600; color: #717171; text-transform: uppercase; letter-spacing: 0.06em; } .inp { width: 100%; background: #F7F7F7; border: 1px solid #EBEBEB; border-radius: 10px; padding: 0.75rem 1rem; color: #222; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.9rem; outline: none; transition: border-color 0.2s, box-shadow 0.2s; } .inp:focus { border-color: #FF5A5F; box-shadow: 0 0 0 3px rgba(255,90,95,0.1); background: #fff; } .inp option { background: #fff; } .btn-primary { background: #FF5A5F; color: #fff; border: none; border-radius: 10px; padding: 0.85rem 1.5rem; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; font-size: 0.9rem; cursor: pointer; transition: background 0.2s; width: 100%; } .btn-primary:hover { background: #e0484d; } .btn-add-trip { width: 100%; display: flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.85rem; border: 1.5px dashed #DDDDDD; border-radius: 12px; background: transparent; color: #717171; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; font-size: 0.88rem; cursor: pointer; transition: all 0.2s; margin-bottom: 1.25rem; } .btn-add-trip:hover { border-color: #FF5A5F; color: #FF5A5F; } .btn-add-icon { font-size: 1.1rem; } .btn-icon { background: none; border: none; cursor: pointer; font-size: 0.9rem; padding: 0.3rem; border-radius: 6px; opacity: 0.6; transition: all 0.15s; } .btn-icon:hover { background: #F7F7F7; opacity: 1; } .btn-icon.small { font-size: 0.8rem; } .empty-state { text-align: center; padding: 3rem 1rem; } .empty-icon { font-size: 2.5rem; margin-bottom: 0.75rem; } .empty-title { font-weight: 600; font-size: 1rem; color: #222; margin-bottom: 0.35rem; } .empty-sub { font-size: 0.85rem; color: #717171; } .cat-picker { display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.5rem; } .cat-btn { display: flex; flex-direction: column; align-items: center; gap: 0.25rem; padding: 0.6rem 0.4rem; border: 1.5px solid #EBEBEB; border-radius: 10px; background: #F7F7F7; cursor: pointer; transition: all 0.15s; font-family: 'Plus Jakarta Sans', sans-serif; } .cat-btn:hover { border-color: #CCCCCC; background: #F0F0F0; } .cat-btn-active { background: #fff; } .cat-btn-emoji { font-size: 1.4rem; line-height: 1; } .cat-btn-label { font-size: 0.68rem; font-weight: 600; color: #484848; } .planning-timeline { display: flex; flex-direction: column; } .planning-day { margin-bottom: 1.5rem; } .planning-day-header { display: flex; align-items: flex-start; gap: 0.75rem; margin-bottom: 0.75rem; } .planning-day-left { display: flex; flex-direction: column; align-items: center; flex-shrink: 0; width: 14px; padding-top: 4px; } .planning-day-dot { width: 14px; height: 14px; border-radius: 50%; background: #FF5A5F; flex-shrink: 0; box-shadow: 0 0 0 3px rgba(255,90,95,0.15); } .planning-day-line { width: 2px; flex: 1; background: #EBEBEB; min-height: 12px; margin-top: 4px; } .planning-day-info { flex: 1; } .planning-day-label { display: inline-block; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #fff; background: #FF5A5F; padding: 2px 8px; border-radius: 20px; margin-bottom: 0.25rem; } .planning-day-name { display: block; font-size: 0.95rem; font-weight: 700; color: #222; } .planning-day-date { display: block; font-size: 0.78rem; color: #717171; margin-top: 0.1rem; } .btn-add-day { background: #F7F7F7; border: none; width: 28px; height: 28px; border-radius: 50%; cursor: pointer; font-size: 1rem; color: #FF5A5F; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: 700; transition: background 0.15s; margin-top: 2px; } .btn-add-day:hover { background: #FFE8E8; } .planning-day-stops { padding-left: 1.75rem; display: flex; flex-direction: column; gap: 0.5rem; } .planning-stop { touch-action: manipulation; } .planning-stop-inner { background: #fff; border: 1px solid #EBEBEB; border-left: 3px solid #FF5A5F; border-radius: 10px; padding: 0.75rem 0.85rem; } .planning-stop-top { display: flex; align-items: flex-start; gap: 0.65rem; } .stop-cat-badge { width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1.1rem; flex-shrink: 0; } .stop-main { flex: 1; min-width: 0; } .planning-stop-city { font-weight: 700; font-size: 0.92rem; color: #222; display: block; } .stop-note { font-size: 0.8rem; color: #717171; line-height: 1.4; margin-top: 0.2rem; } .stop-right { display: flex; align-items: center; gap: 0.1rem; flex-shrink: 0; } .stop-actions { display: flex; gap: 0.1rem; } .drag-handle { font-size: 1.3rem; color: #CCCCCC; cursor: grab; padding: 0.2rem 0.3rem; border-radius: 6px; line-height: 1; touch-action: none; user-select: none; } .drag-handle:hover { color: #999; background: #F7F7F7; } .drag-handle:active { cursor: grabbing; color: #FF5A5F; } .budget-hero { background: linear-gradient(135deg, #FF5A5F, #FC642D); border-radius: 16px; padding: 1.5rem; margin-bottom: 1.25rem; color: #fff; } .budget-hero-label { font-size: 0.8rem; opacity: 0.85; font-weight: 500; margin-bottom: 0.3rem; } .budget-hero-amount { font-size: 2.2rem; font-weight: 700; letter-spacing: -0.03em; margin-bottom: 0.75rem; } .budget-chips { display: flex; flex-wrap: wrap; gap: 0.4rem; } .budget-chip { font-size: 0.75rem; font-weight: 600; padding: 0.25rem 0.65rem; border-radius: 20px; background: rgba(255,255,255,0.2); color: #fff; } .detail-card { background: #fff; border: 1px solid #EBEBEB; border-radius: 16px; padding: 1rem 1.25rem; margin-bottom: 1.25rem; display: flex; flex-direction: column; gap: 1rem; } .detail-row { display: flex; flex-direction: column; gap: 0.35rem; } .detail-top { display: flex; justify-content: space-between; } .detail-label { font-size: 0.88rem; font-weight: 600; color: #222; } .detail-amount { font-size: 0.88rem; font-weight: 700; } .detail-bar { height: 6px; background: #F7F7F7; border-radius: 99px; overflow: hidden; } .detail-bar-fill { height: 100%; border-radius: 99px; transition: width 0.4s; } .detail-pct { font-size: 0.72rem; color: #717171; } .budget-group { background: #fff; border: 1px solid #EBEBEB; border-radius: 12px; margin-bottom: 0.75rem; overflow: hidden; } .group-header { display: flex; justify-content: space-between; padding: 0.75rem 1rem 0.75rem 0.85rem; background: #F7F7F7; font-size: 0.82rem; font-weight: 700; color: #222; } .group-total { color: #484848; } .budget-item { display: flex; justify-content: space-between; align-items: center; padding: 0.7rem 1rem; border-top: 1px solid #F7F7F7; font-size: 0.88rem; } .item-label { color: #484848; } .item-amount { font-weight: 600; color: #222; } .progress-card { background: #F7F7F7; border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.25rem; } .progress-top { display: flex; justify-content: space-between; margin-bottom: 0.6rem; } .progress-label { font-size: 0.83rem; color: #484848; font-weight: 500; } .progress-pct { font-size: 0.83rem; font-weight: 700; color: #FF5A5F; } .progress-bar { height: 5px; background: #DDDDDD; border-radius: 99px; overflow: hidden; } .progress-fill { height: 100%; background: #FF5A5F; border-radius: 99px; transition: width 0.4s; } .todo-input-row { display: flex; gap: 0.6rem; margin-bottom: 1.25rem; } .todo-inp { flex: 1; } .btn-add-inline { width: auto; white-space: nowrap; padding: 0.75rem 1.25rem; } .done-separator { font-size: 0.75rem; font-weight: 700; color: #717171; text-transform: uppercase; letter-spacing: 0.08em; padding: 0.75rem 0 0.5rem; } .todo-list { display: flex; flex-direction: column; gap: 0.5rem; } .todo-item { display: flex; align-items: center; gap: 0.75rem; background: #fff; border: 1px solid #EBEBEB; border-radius: 10px; padding: 0.85rem 1rem; } .todo-item.done { opacity: 0.5; } .todo-check { width: 22px; height: 22px; border-radius: 50%; border: 2px solid #DDDDDD; background: transparent; cursor: pointer; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 0.7rem; color: #fff; transition: all 0.15s; } .todo-check.checked { background: #FF5A5F; border-color: #FF5A5F; } .todo-check:hover { border-color: #FF5A5F; } .todo-text { flex: 1; font-size: 0.9rem; color: #222; } .todo-item.done .todo-text { text-decoration: line-through; color: #717171; } .modal-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.4); display: flex; align-items: center; justify-content: center; z-index: 100; padding: 1.5rem; } .modal { background: #fff; border-radius: 20px; padding: 1.75rem; width: 100%; max-width: 320px; } .modal-title { font-size: 1.1rem; font-weight: 700; color: #222; margin-bottom: 0.5rem; } .modal-sub { font-size: 0.85rem; color: #717171; margin-bottom: 1.5rem; } .modal-actions { display: flex; gap: 0.75rem; } .btn-cancel { flex: 1; padding: 0.75rem; border: 1px solid #EBEBEB; border-radius: 10px; background: #fff; color: #222; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; font-size: 0.9rem; cursor: pointer; } .btn-danger { flex: 1; padding: 0.75rem; border: none; border-radius: 10px; background: #FF5A5F; color: #fff; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; font-size: 0.9rem; cursor: pointer; } .loading { display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; gap: 1rem; color: #717171; font-size: 0.9rem; background: #fff; } .spinner { width: 28px; height: 28px; border: 2px solid #EBEBEB; border-top-color: #FF5A5F; border-radius: 50%; animation: spin 0.7s linear infinite; } @keyframes spin { to { transform: rotate(360deg); } }`}</style>
<div className="app">
{selectedVoyage ? (
